...
{
    LCD_ShowString(25,5,"Init OK!!!",BLUE,BLACK,14,0);
    LCD_ShowString(20,21,"CH32V307VCT6",RED,BLACK,14,0);
    LCD_ShowString(20,37,"test",YELLOW,BLACK,14,0);
    LCD_ShowString(20,53,"test",GREEN,BLACK,14,0);
}
