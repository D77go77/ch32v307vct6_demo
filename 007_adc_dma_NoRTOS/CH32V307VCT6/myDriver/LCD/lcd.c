...
{
    LCD_ShowString(20,5,"CH32V307VCT6",RED,BLACK,16,0);
    LCD_ShowString(20,20,"MPU6050",RED,BLACK,16,0);
    LCD_ShowString(1,35,"ROL",GREEN,BLACK,16,0);    LCD_ShowFloatNum_pro(50, 35, smartcar_imu.rpy_deg[ROL], 5, 2, YELLOW, 16);
    LCD_ShowString(1,50,"PIT",GREEN,BLACK,16,0);    LCD_ShowFloatNum_pro(50, 50, smartcar_imu.rpy_deg[PIT], 5, 2, YELLOW, 16);
    LCD_ShowString(1,65,"YAW",GREEN,BLACK,16,0);    LCD_ShowFloatNum_pro(50, 65, smartcar_imu.rpy_deg[YAW], 5, 2, YELLOW, 16);
    LCD_ShowString(1,80,"TEMP",GREEN,BLACK,16,0);   LCD_ShowFloatNum_pro(50, 80, smartcar_imu.temperature_filter, 5, 2, YELLOW, 16);
    LCD_ShowString(1,95,"ADC",GREEN,BLACK,16,0);    LCD_ShowFloatNum_pro(50, 95, vbat.value, 4, 2, YELLOW, 16);
}
...
/******************************************************************************
      ...
      返回值：  无
******************************************************************************/
void LCD_ShowFloatNum_pro(u16 x, u16 y, float num, u8 len, u16 fc, u16 bc, u8 sizey)
{
    u8 t, temp, sizex;
    u16 num1;
    sizex = sizey / 2;
    ...
    if (num < 0) {
        ...
        x += sizex; // x坐标右移，为数字腾出空间
    }
    num1 = num * 100; // 将小数部分扩大为整数，保留两位小数
    for (t = 0; t < len; t++) {
